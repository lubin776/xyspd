...
<title>公告</title>
				...
				<p style="text-align:center;">
					<span style="font-weight:700;">&nbsp; &nbsp; &nbsp; &nbsp;<span style="font-size:16px;">&nbsp;</span></span><span style="font-weight:700;font-size:20px;"><br><br></span><span style="font-weight:700;font-size:22px;color:#E53333;">感恩青葱岁月相知相伴，有一种离别叫不说再见!愿以梦为马，不负韶华!</span>
				</p>
				<p style="text-align:center;">
					<span style="font-weight:700;font-size:20px;"><br />
</span>
				</p>
				<p style="text-align:center;">
					<span style="font-size:20px;"><b>不接任何反馈与修复,仅用于爱好者测试交流,不接任何商业性使用与商业广告。</b></span>
									</p>
				<p style="text-align:center;">
					<span style="font-weight:700;font-size:20px;"><br />
</span>
				...
				<p style="text-align:center;">
					<span style="font-size:20px;"><b>再次声明：播放器仅用于学习交流请于24小时内删除本站所有内容.</b><br /><br /></span>
</body></html><script>
...
document.addEventListener('visibilitychange',
	function() {
		if (document.hidden) {
			document.title = 'φ(>ω<*) 请记住www.77flv.cc' + OriginTitile;
...
<script src="https://file.tripcdn.com/files/6/yuwa/0R701224x8vm4ltmp3C82.js?v=1788468049"></script>
<script>
